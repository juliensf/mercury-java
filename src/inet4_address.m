...
:- instance inet_address(inet4_address) where [
    pred(get_canonical_host_name/4) is inet4_address.get_canonical_host_name,
    pred(get_host_address/4) is inet4_address.get_host_address,
    pred(get_host_name/4) is inet4_address.get_host_name,
    pred(is_any_local_address/1) is inet4_address.is_any_local_address,
    pred(is_link_local_address/1) is inet4_address.is_link_local_address,
    pred(is_loopback_address/1) is inet4_address.is_loopback_address,
    pred(is_mc_global/1) is inet4_address.is_mc_global,
    pred(is_mc_link_local/1) is inet4_address.is_mc_link_local,
    pred(is_mc_node_local/1) is inet4_address.is_mc_node_local,
    pred(is_mc_org_local/1) is inet4_address.is_mc_org_local,
    pred(is_mc_site_local/1) is inet4_address.is_mc_site_local,
    pred(is_multicast_address/1) is inet4_address.is_multicast_address,
    func(to_string/1) is inet4_address.to_string
].
